...
public class ShellAgentTask extends AbstractAgentTask {
    ...
    public static final String PARAM_ATTACHMENT_VERSION    = "attachmentVersion";
    public static final String PARAM_ATTACHMENT_SERVER_URI = "attachmentServerUri";
    public static final String PARAM_SHELL_COMMAND         = "shellCmd";
