...
public class WorkflowExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addStatusCriterion(String condition, Object value, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value, "com.yeahmobi.yscheduler.model.type.WorkflowStatusHandler"));
            allCriteria = null;
        }

        protected void addStatusCriterion(String condition, WorkflowStatus value1, WorkflowStatus value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            statusCriteria.add(new Criterion(condition, value1, value2, "com.yeahmobi.yscheduler.model.type.WorkflowStatusHandler"));
            allCriteria = null;
        }
        ...
        public Criteria andStatusEqualTo(WorkflowStatus value) {
            addStatusCriterion("status =", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusNotEqualTo(WorkflowStatus value) {
            addStatusCriterion("status <>", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusGreaterThan(WorkflowStatus value) {
            addStatusCriterion("status >", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusGreaterThanOrEqualTo(WorkflowStatus value) {
            addStatusCriterion("status >=", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusLessThan(WorkflowStatus value) {
            addStatusCriterion("status <", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusLessThanOrEqualTo(WorkflowStatus value) {
            addStatusCriterion("status <=", value, "status");
            return (Criteria) this;
        }

        public Criteria andStatusIn(List<WorkflowStatus> values) {
            addStatusCriterion("status in", values, "status");
            return (Criteria) this;
        }

        public Criteria andStatusNotIn(List<WorkflowStatus> values) {
            addStatusCriterion("status not in", values, "status");
            return (Criteria) this;
        }

        public Criteria andStatusBetween(WorkflowStatus value1, WorkflowStatus value2) {
            addStatusCriterion("status between", value1, value2, "status");
            return (Criteria) this;
        }

        public Criteria andStatusNotBetween(WorkflowStatus value1, WorkflowStatus value2) {
