...
public class TaskInstanceServiceImplTest {
    ...
    public void testGet() throws Exception {
        ...
        assertTaskInstance(instance, 1L, sdf.parse("2014-11-26 17:37:00"), sdf.parse("2014-11-26 17:38:30"),
                           "2014-11-26 17:38:00", "2014-11-26 17:38:10", null, TaskInstanceStatus.RUNNING, 1L, 1L);
    }
    ...
    public void testGetLast() throws Exception {
        ...
        task.setId(1l);
        task.setCrontab("*/5 * * * *");
        assertTaskInstance(this.instanceService.getLast(task, instance4), instance1.getId(), instance1.getCreateTime(),
                           instance1.getUpdateTime(), sdf.format(instance1.getScheduleTime()),
                           sdf.format(instance1.getStartTime()), sdf.format(instance1.getEndTime()),
                           instance1.getStatus(), instance1.getTaskId(), instance1.getWorkflowInstanceId());
        TaskInstance newTaskInstance = new TaskInstance();
        newTaskInstance.setScheduleTime(sdf.parse("2014-11-26 00:20:00"));

        assertTaskInstance(this.instanceService.getLast(task, newTaskInstance), instance5.getId(),
                           instance5.getCreateTime(), instance5.getUpdateTime(),
                           sdf.format(instance5.getScheduleTime()), sdf.format(instance5.getStartTime()),
                           sdf.format(instance5.getEndTime()), instance5.getStatus(), instance5.getTaskId(),
    ...
    public void testListByWorkflowInstanceId() throws Exception {
        ...
        for (int i = 1; i <= taskInstances.size(); i++) {
            ...
            assertTaskInstance(instance, Long.valueOf(20 + i), sdf.parse("2014-11-26 17:37:00"),
                               sdf.parse("2014-11-26 17:38:30"), "2014-11-26 17:38:00", "2014-11-26 17:38:10",
                               "2014-11-26 17:38:30", TaskInstanceStatus.SUCCESS, 21L, 21L);
        }
    }
    ...
    public void testListByWorkflowInstanceIdPagination() throws Exception {
        ...
        assertTaskInstance(taskInstances.get(0), Long.valueOf(31), sdf.parse("2014-11-26 17:37:00"),
                           sdf.parse("2014-11-26 17:38:30"), "2014-11-26 17:38:00", "2014-11-26 17:38:10",
                           "2014-11-26 17:38:30", TaskInstanceStatus.SUCCESS, 21L, 21L);
    }
    ...
    public void testListByTaskId() throws Exception {
        ...
        for (int i = 1; i <= taskInstances.size(); i++) {
            TaskInstance instance = taskInstances.get(i - 1);
            assertTaskInstance(instance, Long.valueOf(32 - i), sdf.parse("2014-11-26 17:37:00"),
                               sdf.parse("2014-11-26 17:38:30"), "2014-11-26 17:38:00", "2014-11-26 17:38:10",
                               "2014-11-26 17:38:30", TaskInstanceStatus.SUCCESS, 21L, 21L);
        }
    }
    ...
    public void testListByTaskIdPagination() throws Exception {
        ...
        Assert.assertEquals(1, taskInstances.size());
        assertTaskInstance(taskInstances.get(0), Long.valueOf(21), sdf.parse("2014-11-26 17:37:00"),
                           sdf.parse("2014-11-26 17:38:30"), "2014-11-26 17:38:00", "2014-11-26 17:38:10",
                           "2014-11-26 17:38:30", TaskInstanceStatus.SUCCESS, 21L, 21L);
    }
    ...
    public void testListAllDependencyWait() throws Exception {
        ...
        Assert.assertEquals(1, taskInstances.size());
        assertTaskInstance(taskInstances.get(0), Long.valueOf(8), sdf.parse("2014-11-26 17:37:00"),
                           sdf.parse("2014-11-26 17:38:30"), null, null, null, TaskInstanceStatus.DEPENDENCY_WAIT, 8L,
                           8L);
    }
    ...
    public void testGetAllUncompleteds() throws Exception {
        ...
        Assert.assertEquals(2, taskInstances.size());
        assertTaskInstance(taskInstances.get(0), Long.valueOf(1), sdf.parse("2014-11-26 17:37:00"),
                           sdf.parse("2014-11-26 17:38:30"), "2014-11-26 17:38:00", "2014-11-26 17:38:10", null,
                           TaskInstanceStatus.RUNNING, 1L, 1L);
        assertTaskInstance(taskInstances.get(1), Long.valueOf(2), sdf.parse("2014-11-26 17:37:00"),
                           sdf.parse("2014-11-26 17:37:00"), "2014-11-26 17:38:00", null, null,
                           TaskInstanceStatus.READY, 2L, 2L);
    }
    ...
    public void testUpdateStatus() throws Exception {
        ...
        Date now = new Date();
        assertTaskInstance(this.instanceService.get(1L), Long.valueOf(1), sdf.parse("2014-11-26 17:37:00"), now,
                           "2014-11-26 17:38:00", "2014-11-26 17:38:10", sdf.format(now), TaskInstanceStatus.SUCCESS,
                           1L, 1L);
        assertTaskInstance(this.instanceService.get(2L), Long.valueOf(2), sdf.parse("2014-11-26 17:37:00"), now,
                           "2014-11-26 17:38:00", sdf.format(now), null, TaskInstanceStatus.RUNNING, 2L, 2L);
    }
    ...
    public void testSave() throws Exception {
        ...
        assertTaskInstance(instance, instance.getId(), now, now, sdf.format(now), sdf.format(now), sdf.format(now),
                           TaskInstanceStatus.SUCCESS, 1L, 2L);
    }
    ...
    public void testListByWorkflowInstanceIdAndUserId() throws Exception {
        ...
        List<TaskInstance> listByWorkflowInstanceIdAndUserId = this.instanceService.listByWorkflowInstanceIdAndUserId(1,
                                                                                                                      1);
    ...
    private void assertTaskInstance(TaskInstance instance, Long id, Date createTime, Date updateTime,
                                    String scheduleTime, String startTime, String endTime, TaskInstanceStatus status,
                                    Long taskId, Long workflowInstanceId) {
