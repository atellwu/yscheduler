...
public class Constants {
    ...
    public static final int      DEFAULT_AGENT_PORT              = 24368;
    ...
    public static final Pattern  USER_TELEPHONE_PATTERN          = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$");

    public static final String   USER_EMAIL_suffix               = "@ndpmedia.com";

    public static final String   ATTACHMENT_NAMESPACE_ATTEMPTLOG = "attempt-log";
    public static final String   ATTACHMENT_NAMESPACE            = "task";
