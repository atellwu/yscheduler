...
JAVA_OPTIONS=("$JAVA_OPTIONS" "-Dagent.home=$JETTY_HOME" "-Djetty.home=$JETTY_HOME" "-Djetty.base=$JETTY_BASE" "-Djava.io.tmpdir=$TMPDIR" "-Duser.timezone=GMT+0" "-server -Xmx256m -Xms256m -XX:PermSize=32m -Xss256k -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:+UseCMSCompactAtFullCollection -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70")
